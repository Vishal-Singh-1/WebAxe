// Simple accessible hamburger/menu behaviour.
// Add this file to webaxe-frontend/src and import it from src/main.jsx:
//   import './hamburger.js';
//
// It expects these IDs from your HTML:
//  - #hamburger-btn        (button that toggles the menu)
//  - #mobile-menu          (aside / menu container)
//  - #menu-backdrop        (full-screen backdrop)
//  - #mobile-close         (a close button inside the menu)
//
// The script toggles aria attributes, body.nav-open, manages focus and traps Tab inside the menu.
